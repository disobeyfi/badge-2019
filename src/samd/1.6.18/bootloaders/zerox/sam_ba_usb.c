...
#  define STRING_MANUFACTURER "Disobey 2019"
//#endif

//#ifndef STRING_PRODUCT
#  define STRING_PRODUCT "purkkaviritys should have been here"
//#endif
...
void sam_ba_usb_CDC_Enumerate(P_USB_CDC pCdc)
{
  ...
  switch ((bRequest << 8) | bmRequestType)
  {
    ...
    case GET_LINE_CODING:
      ...
      pUsb->DEVICE.DeviceEndpoint[0].EPSTATUSCLR.reg = USB_DEVICE_EPSTATUSCLR_BK0RDY;
      USB_Write(pCdc->pUsb, (char *) &line_coding, SAM_BA_MIN(sizeof(usb_cdc_line_coding_t)-1, wLength), USB_EP_COMM);
    break;
