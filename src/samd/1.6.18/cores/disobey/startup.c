...
#define GENERIC_CLOCK_GENERATOR_OSC8M_div2     (4u)
...
//                      GCLK_GENCTRL_OE | // Output clock to a pin for tests
  ...
  /* ----------------------------------------------------------------------------------------------
   * 7) Put OSC8M as source for Generic Clock Generator 3 and 4
   */
...
//                      GCLK_GENCTRL_OE | // Output clock to a pin for tests
  ...
  GCLK->GENDIV.reg = GCLK_GENDIV_ID( GENERIC_CLOCK_GENERATOR_OSC8M_div2 )|(2<<8) ; // Generic Clock Generator 4

  /* Write Generic Clock Generator 4 configuration */
  GCLK->GENCTRL.reg = GCLK_GENCTRL_ID( GENERIC_CLOCK_GENERATOR_OSC8M_div2 ) | // Generic Clock Generator 3
                      GCLK_GENCTRL_SRC_OSC8M | // Selected source is RC OSC 8MHz (already enabled at reset)
                      GCLK_GENCTRL_GENEN ;
  ...
  /*
  GCLK->CLKCTRL.reg = GCLK_CLKCTRL_ID( PTC_GCLK_ID ) | // PTC
